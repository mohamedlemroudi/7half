...
import MachineDeck from './MachineDeck.js';
...
export default class Game {
  ...
  playCard(posCard) {
    ...
    if (this.playerDeck.resultatDeck <= 7.5 && posCard <= (Game.MAXCARD/2) &&
      ...
      this.playerDeck.jugada(this.deckMaster, posCard, this.controller);
  ...
  playMachine() {
    ...
    this.computerDeck.jugarMaquina(this.computerDeck, this.deckMaster,
        6, Game.MAXCARD, this.controller);
  ...
  getWinner() {
    ...
    return jury.buscarGuanyador(this.playerDeck, this.computerDeck);
  }
}
